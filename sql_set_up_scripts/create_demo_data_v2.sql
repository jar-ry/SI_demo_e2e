...
-- =====================================================
-- STEP 4: CREATE TABLES AND POPULATE DATA
-- =====================================================
            ...
            WHEN (sale_date BETWEEN '2025-09-26' AND '2025-09-27') AND (postcode LIKE '3%') THEN
                CASE 
                    ...
                    WHEN sale_date = '2025-09-26' THEN
                        CASE 
                            WHEN product_id > 4 AND product_id <= 8 THEN base_revenue * (1.7 + UNIFORM(0, 1, RANDOM()) * 0.4) -- Apparel surge 170-210%
                            WHEN product_id > 16 THEN base_revenue * (1.7 + UNIFORM(0, 1, RANDOM()) * 0.3) -- Food surge 170-210%
                    ...
                    WHEN sale_date = '2025-09-27' THEN
                        CASE 
                            WHEN product_id > 4 AND product_id <= 8 THEN base_revenue * (1.7 + UNIFORM(0, 1, RANDOM()) * 0.5) -- Apparel surge 170-210%
                    ...
                    WHEN sale_date IN ('2025-09-28', '2025-09-29', '2025-09-30') THEN
                        CASE 
                            WHEN product_id > 12 AND product_id <= 16 THEN base_revenue * (1.8 + UNIFORM(0, 1, RANDOM()) * 0.3) -- Electronics surge 180-210%
