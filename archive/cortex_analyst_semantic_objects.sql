...
SELECT 
    ...
    CASE 
        WHEN f.sale_date BETWEEN '2024-02-01' AND '2024-02-28' THEN 'Cyclone Alfred'
        WHEN f.sale_date BETWEEN '2025-09-26' AND '2025-09-30' THEN 'AFL Grand Finals'
        ELSE 'Normal Period'
    END as event_name,
    -- Event period classification
    CASE 
        -- Cyclone Alfred periods
        WHEN f.sale_date < '2024-02-01' THEN 'Pre-Event'
        WHEN f.sale_date BETWEEN '2024-02-01' AND '2024-02-15' THEN 'During Event'
        WHEN f.sale_date BETWEEN '2024-02-16' AND '2024-02-28' THEN 'Post-Event'
